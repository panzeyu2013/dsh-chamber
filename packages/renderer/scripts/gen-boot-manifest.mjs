 ...
 * The pattern ALONE is not sufficient: a shared chunk whose inferred name
 * also begins with `chamber-` can match it. The row must therefore also be a
 * real entry (`isEntry === true`) — shared chunks carry no
