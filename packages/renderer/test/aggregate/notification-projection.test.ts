/**
 * P3 单通知投影契约：两条证据、一个策略、一个身份账本（v4 身份表 + v5 水位账本）。
 *
 * goal-aware v5 P1 增量（本文件下半部分）：水平收敛器 reconcile —— G1–G5 前置门、
 * §3.4 的 12 条裁决、水位吸收、settleFence、结算守卫、outcomes 一次性标题、
 * INV1–INV8 与 TL1–TL3 反例序列。
 */
