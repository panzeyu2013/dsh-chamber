...
import {
  ...
  __testEntryStates, __testOpenedSessions, __testPresentedSession, __testQueueDisposeGate,
  __testQueueRunGate, __testReleasedSessions, __testResetConfiguredContexts, __testResetDisposed,
  __testResetEventLog, __testResetLifecycle, __testRetainCalls, __testSetNavigationAvailable,
  __testSetNavigationReadError, __testSetReflectAvailable,
  __testSetSessionsAvailable, __testSetSessionsListed, __testSetSessionsOpenError, __testSetSessionsReadError,
