/**
 * N-ctx shell orchestration (design 05 /): one AppWebEntry per dsh
...
/**
 * The page's ONE machine application catalog (design 20 ).
 ...
 * same container — the 05  no-zombie invariant. Fresh boots started after
