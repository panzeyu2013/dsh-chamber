...
export default function InstanceView({
  ...
  // P2: the frame's releaseAtMonoMs is ABSOLUTE, so the timer delay is the distance
  ...
  // P1/P2：遮罩在**已 settle** 的壳上仍然可见，就是打开意图揭示门在持有它（boot 期
      ...
      {veilVisible && (
        <div className="instance-loading" aria-busy={veilActions || retryQueued ? false : true}>
          <div className="instance-loading-main">
            ...
            {/* W4：排队事实一成立就播报——它挂在反馈窗（`PRESENTATION_THRESHOLDS.veilActionsAfterMs`）之外：
