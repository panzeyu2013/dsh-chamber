/**
 * Browser stand-in for `node:module` (copied from dsh apps/web). `createRequire`
 * is unreachable in the configured loader path and fails loud if that assumption changes.
 */
