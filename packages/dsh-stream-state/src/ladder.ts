 ...
 * (docs/progress/todo/session-authority-refactor.md). The former renderer-local
 * `planSessionLiveness` planner is retired; its scheduling half is exactly these tiers.
 *
