 ...
 *
 * 钉住一条产品纪律：'dsh-chamber:notify' 的失败**必须带原因**（宿主/OS 原文或
 * 本进程裁决原因）——macOS 通知权限被拒后不再弹授权框，用户唯一的恢复路径就是
 * 从设置页看到原因并去「系统设置 → 通知」打开。原因在这里被吞掉 = 用户回到黑箱。
 *
 * 反向也要钉：成功不带原因、空串/非字符串不制造假原因、reject 路径同样如实。
 */
