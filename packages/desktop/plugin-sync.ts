...
/** App-quit barrier for local pack/plugin children and their Unix groups. */
export async function disposeLocalPluginChildren(): Promise<void> {
  await localPluginChildSupervisor.dispose()
}
