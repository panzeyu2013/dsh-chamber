...
// The observable plumbing is the store
 ...
 *  (The vite-composited bundle inlines value imports, and the slots
 ...
 *
 * The snapshot/subscribe plumbing is the dsh
 ...
 * identity behaviour (`set` with a plain array — never `update`,
