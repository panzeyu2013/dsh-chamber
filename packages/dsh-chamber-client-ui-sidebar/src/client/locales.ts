...
export const zh = {
  ...
  'todo.title': '会话待办',
  'todo.region.aria': '需要你处理的会话：完成未读、等待批准或等待回答',
  'todo.row.aria': '{state}：{title}',
  'todo.more': '还有 {n} 项',
  'todo.fewer': '收起',
  'hover.copied': '已复制',
...
export const en = {
  ...
  'todo.region.aria': 'Sessions needing your attention: completed unread, waiting for approval or your answer',
  'todo.row.aria': '{state}: {title}',
  'todo.more': '{n} more',
  'todo.fewer': 'Collapse',
  'hover.copied': 'Copied',
