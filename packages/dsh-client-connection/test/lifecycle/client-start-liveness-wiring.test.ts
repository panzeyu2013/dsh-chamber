 ...
 * `test/lifecycle/client-apply.test.ts` stops at `apply()` (it never calls `start()`), and
 * `test/recovery/liveness-triggers.test.ts` drives `attachLivenessTriggers` directly, so
