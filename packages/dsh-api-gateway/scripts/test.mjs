 ...
 * never a silent skip.
 *
 * Both suites are dependency-free: the retry-policy truth table exercises the pure
 * pacing module, and the patch lock reads source text, so the fork patch is covered
 * even where the vendor install is absent.
 */
