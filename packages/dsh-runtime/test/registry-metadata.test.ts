...
import { fetchRegistryMetadata, fetchRegistryResponse, type RegistryMetadata } from '../src/registry-metadata.ts';
import { registryRedirectOrigins } from '../src/registry-url.ts';
