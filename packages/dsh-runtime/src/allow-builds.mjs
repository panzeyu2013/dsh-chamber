/**
 * dsh runtime allowBuilds 白名单 —— 单一来源常量（design 18 §4）。
 *
 * 构建期 bundler（scripts/bundle-dsh.mjs）与运行期安装器
 ...
 *   有它，但该版本**没有**任何 install/preinstall/postinstall 脚本（已实测），
 *   所以这一条是惰性的防御性登记——将来版本若加上安装脚本，pnpm 会按我们的裁决
 *   拒绝执行而不是硬失败。
 *
