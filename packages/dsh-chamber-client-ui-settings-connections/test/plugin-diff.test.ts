...
function local(
  ...
  return { dependencies, bundles, clientLines, bundleLines, unsyncable, chamber: { ok: true, hostGraph: { installed: false, patched: false, version: null, live: null }, gitWorktree: { installed: false, patched: false, version: null, live: null } } }
}
