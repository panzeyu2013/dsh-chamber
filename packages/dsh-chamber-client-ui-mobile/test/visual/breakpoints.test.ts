...
// Local variant of the shared stripComments: CSS-only scanner — the input is a bare stylesheet with no JS string/template literals to protect, so a block-comment regex is sufficient (scripts/dev/test-support/source-text.ts)
