...
export function sessionStallFace(
  ...
  return {
    openInFlight: (): boolean | undefined => {
      ...
      try {
        // The member MUST exist for FALSE: a renamed/removed openPromise
        // degrades to "unknown", never to "nothing pending".
        ...
        // anything else non-thenable is UNKNOWN and fails closed.
