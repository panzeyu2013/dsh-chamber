...
| 17 | [17-dsh-runtime-version.md](17-dsh-runtime-version.md) | 设计定稿（2026-08，未实现） | dsh 运行时版本管理：运行期 npm 拉取安装（唯一获取方式，无 Provider B）、settings 版本选择/回滚 + registry 源用户自设、探针门控激活 + 自动回退、三版本缓存、无验证区分 |
