...
scripts/
  ...
  upstream/                 Upstream pin and touchpoints (update-vendor, pin preflight, C1–C15 touchpoint gates, anchor gates, C8 artifact gate)
