...
| 5 | [24-archived-session-cleanup-plan.md](24-archived-session-cleanup-plan.md) | 已归档会话清理执行台账（design 24 companion：M0 评审包/决策点 D1–D7、vendor 前置核对记录表、M1–M4 任务与门禁） | M0 就绪待评审；vendor 前置核对阻塞（子模块未物化，2026-12） |
