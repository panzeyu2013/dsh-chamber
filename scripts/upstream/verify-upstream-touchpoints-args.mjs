 ...
 * imported by a test).
 *
 * WHY THIS EXISTS: the gate runs C1/C3–C16 on EVERY invocation, and its default
...
export const VERIFY_USAGE = `verify-upstream-touchpoints — 上游触点保鲜门（C1/C3–C16；docs/checklists/upstream-touchpoints.md 的机器侧）
...
默认模式（无参数）：跑 C1/C3–C16，其中 C8 会**就地重建并原样还原**构建期生成物
