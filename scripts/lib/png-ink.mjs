 ...
 *
 * 从 scripts/dev/svg-resource-probe.mjs:193-263 抽出（W3 白帧验收 Leg B 的像素半）：
 * 原实现是 WKWebView 真机探针私有的解码器，只支持探针自己产出的 8bit RGB/RGBA。
 ...
 *    "那块单色"就是它。**不能用平均色**（内容可能恰好均值等于背景，蓝图 §7.6-3）。
