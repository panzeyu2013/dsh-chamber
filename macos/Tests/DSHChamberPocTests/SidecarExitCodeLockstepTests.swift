...
final class SidecarExitCodeLockstepTests: XCTestCase {
    ...
    /// #filePath = <repo>/macos/Tests/DSHChamberPocTests/SidecarExitCodeLockstepTests.swift
    ...
    func testSidecarExitCodesStayInLockstepWithTypeScriptSingleSource() throws {
        ...
        let supervisor = try source("macos/Sources/DSHChamberPoc/SidecarSupervisor.swift")
