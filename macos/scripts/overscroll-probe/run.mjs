...
// 并复核 design 25 §5.2 / deviations S-50（否则注入面会在无人察觉时漂移）。
...
check('注入串指纹 == 签入锚（bytes=' + modes.harness.policyBytes + '）',
  ...
  'sha256=' + modes.harness.policySHA256 + '（若是有意改动注入串：同步更新 POLICY_SHA256_PIN 并复核 S-50/§5.2）')
