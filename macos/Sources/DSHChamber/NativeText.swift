...
public enum NativeTextKey: String, CaseIterable {
    ...
    case recoveryExitButton = "recovery.exitButton"
    case recoveryRestartButton = "recovery.restartButton"
    case recoverySafeModeRestartButton = "recovery.safeModeRestartButton"
