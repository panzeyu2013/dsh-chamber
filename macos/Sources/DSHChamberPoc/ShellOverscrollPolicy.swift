//  ShellOverscrollPolicy.swift —— 主窗 WebView 的视口越界策略（design 25 §5.1）
//
...
//  属对上游的破坏性变更（design 25 §5.1 的 Rejected alternatives）。
//
...
//  双 flavor 差异登记见 docs/progress/deviations.md S-48。
//
